...
public class JSpinnerCellEditorRendererTable extends AbstractCellEditorRendererTable implements ChangeListener {
    ...
    public JSpinnerCellEditorRendererTable setDateModel(String padraoFormatacao) {
        this.spinner.setModel(new SpinnerDateModel());
        this.spinner.setEditor(new JSpinner.DateEditor(this.spinner, padraoFormatacao));
        return this;
    }
